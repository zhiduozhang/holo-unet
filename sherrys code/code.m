...
for index = 1:length(UP)
    ...
    disp(newname{1})
    saveas(gcf,[input_folder,'\data\', newname{1},'Figure.png']);
    close all
    save([input_folder,'\data\', newname{1},'heightmap.mat'],'height_r');
    xlswrite([input_folder,'\data\', newname{1},'data.xlsx'], volume','v');
    xlswrite([input_folder,'\data\', newname{1},'data.xlsx'], height_peak','p');
    xlswrite([input_folder,'\data\', newname{1},'data.xlsx'], area','area');
